  ...
  it("renders OpenCode terminal and details as separate panes", () => {
    const html = renderToStaticMarkup(
      <TmuxTtyView
        ...
        sidebar={{ kind: "opencode", output: "Session title\n\nContext\n25,467 tokens" }}
      />
    );
    ...
    expect(html).toContain("tmux-opencode-sidebar-header");
    expect(html).toContain("Session title");
    expect(html).toContain("tmux-opencode-sidebar-section context");
